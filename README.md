...
The main package vignettes can be on Github here: [Main Vignette](./GitHub_vignettes/Diel-Niche-vignette.md) and [Additional Vignette](./GitHub_vignettes/Diel-Niche-Additional.md)
...
![alt text](https://img.shields.io/badge/license-GPL--3-blue.svg)
