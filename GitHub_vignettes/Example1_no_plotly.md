...
#> 111 Didelphis virginiana        5  20    39        1616   131 12/29/2018 1/24/2019 41.87236 -87.8423 Winter United States Chordata
#>        class           order      family             Project unit_type      Common_name Activity_Literature min_year
#> 111 Mammalia Didelphimorphia Didelphidae UWIN_Chicago_IL_USA     28day Virginia Opossum           Nocturnal     2018
```
...
of interest by plotting the set together as,

``` r
diel.plot(hyp=hyp.sets("Traditional"))
```

![](Example1_no_plotly_files/figure-gfm/example1.md.github.png)<!-- -->
...
![](Example1_no_plotly_files/figure-gfm/chains-1.png)<!-- -->
...
![](Example1_no_plotly_files/figure-gfm/plot-1.png)<!-- -->
...
![](Example1_no_plotly_files/figure-gfm/plot2-1.png)<!-- -->

Alternatively, we can use the diel.plot function in the Diel.Niche
package that uses plotly to output a 3d plot of the posterior samples on
top of the hypothesis set,

``` r
diel.plot(hyp=hyp.sets("Traditional"),
          posteriors=out$post.samp.ms.model, more.points = TRUE)
```

![](Example1_no_plotly_files/figure-gfm/example1.md.github.posteriors.png)<!-- -->
...
#> 2.5%  0.03435815 0.2099661 0.4785300
#> 50%   0.08513012 0.3108329 0.5986497
#> 97.5% 0.17213840 0.4284338 0.7108151
```
