...
diel.ineq=function(e=NULL,
                   ...
                   xi.min.dom=NULL, separation=NULL){
...
#Using general hyps with 4 type of cathemeral
  ...
  b.CRD <- c(xi.min.dom[2]-small.num-1,-xi.min.dom[2]-separation,xi.min.dom[1]-small.num-separation,-xi.min.dom[2],xi.min.dom[1]-small.num-separation)
  CRD.Gen=list(Name="Cath[CR.D]",A=A.CRD,b=b.CRD,func="bf_multinom")   

  #DN
  A.DN <- matrix(c(1,0,0,-1,0,1,1,1,-1,-1),ncol = 2, byrow = TRUE)
  b.DN <- c(xi.min.dom[2]-small.num,-xi.min.dom[2]-separation,xi.min.dom[1]-small.num-separation,-xi.min.dom[2]+1,xi.min.dom[1]-small.num-1-separation)
  DN.Gen=list(Name="Cath[D.N]",A=A.DN,b=b.DN,func="bf_multinom")   
  
  #CRN
  A.CRN <- matrix(c(0,1,1,1,-1,-1,-1,0,1,0),ncol = 2, byrow = TRUE)
  b.CRN <- c(xi.min.dom[2]-small.num,-xi.min.dom[2]+1-separation,xi.min.dom[1]-small.num-1-separation,-xi.min.dom[2],xi.min.dom[1]-small.num-separation)
...
##################################################
  ...
  inputs=list(e.D=e.D, e.Dn=e.Dn, e.Dcr=e.Dcr, 
              ...
              xi.EC=xi.EC, p.avail=p.avail,separation)  
